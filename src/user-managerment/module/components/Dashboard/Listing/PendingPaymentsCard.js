    ...
    <div className=" bg-white">
      <div className="flex justify-between py-3 border-b border-solid">
        ...
        <div>
          ...
          {/* view more button */}
          <span  onClick={() => navigate("/home/sell-coin/:coinId/sell-order-statement")} className="bg-[#F4EFFE] rounded-[32px] h-[35px] px-4 mt-2 inline-flex items-center justify-center hover:bg-gray-200 cursor-pointer text-[#3A0CA3] text-xs font-normal">
            View More
          </span>
        </div>
      </div>
      ...
      <div className="flex justify-between py-3 border-b border-solid">
        ...
        <div>
          ...
          {/* view more button */}
          <span onClick={() => navigate("/home/buy-coin/:order-statement/report-order-statement")} className="bg-[#F4EFFE] rounded-[32px] h-[35px] px-4 mt-2 inline-flex items-center justify-center hover:bg-gray-200 cursor-pointer text-[#3A0CA3] text-xs font-normal">
            View More
          </span>
        </div>
      </div>
