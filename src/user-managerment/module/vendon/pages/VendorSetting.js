        ...
        <div className="flex flex-col gap-6 w-full min-h-fit pb-20 px-4">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="p-3 flex flex-col gap-8 bg-[#FAFAFB] rounded-lg">
              ...
              <SettingOptionCards Icon={ProfileCircle} title={"My Users"} />

              <SettingOptionCards Icon={Bank} title={"Banks"} />

              <SettingOptionCards Icon={Receipt1} title={"Transactions"} />

              <SettingOptionCards Icon={Lock1} title={"Change Password"} />

              <SettingOptionCards Icon={Lock1} title={"Change Pin"} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="p-3 flex flex-col gap-8 bg-[#FAFAFB] rounded-lg">
              ...
              <SettingOptionCards Icon={Messages} title={"Send us a Chat"} />
            </div>
          </div>
          {/* legal group  */}
          <div className="flex flex-col gap-3 w-full">
