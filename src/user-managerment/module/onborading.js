...
const Onborading = ()=>{
    return(
        <div className="onboraing-form">
            ...
            <div className="showal-form">
                <Link to="/vendon-register" className="link-transfer" style={{textDecoration: "none"}}>
                    <Row gutter={32} className="gutter-row">
                        <Col span={6}>
                            <div className="vendor-sub">I am a Vendon</div>
                        <div className="vendor-head">
                            A Vendon user is capable of creating several users and is typical for register.
                        </div>
                        <RightOutlined className="arrow-line"/>
                        </Col>
                    </Row>
                </Link>
            </div>
            ...
            <div className="individual-form">
                <Link to="/individual-register" className="link-transfer">
                    <Row gutter={32} className="gutter-row" style={{textDecoration: "none"}}>
                        <Col span={6}>
                            <Title className="title-form">I am an Individual</Title>
                        <div className="individual-head">
                            An individual user account is mostly prefered for personal use
                        </div>
                          <RightOutlined  className="side-arrow"   />
                        </Col>
                    </Row>
                </Link>
