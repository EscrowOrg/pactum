              ...
              <form className="flex flex-col gap-5 w-full h-full">
                ...
                <label className="flex flex-col gap-2 w-full">
                  ...
                  {touched.emailAddress && errors.emailAddress && (
                    <FormError text={errors.emailAddress} />
                  )}
                </label>
                ...
                <div className="flex w-full flex-col mt-auto items-center gap-10">
                  ...
                  <div className="flex flex-col gap-4 w-full items-center justify-center">
                    ...
                    <div className="flex gap-8 items-center">
                      {/* google */}
                      <span className="h-[56px] w-[56px] border border-[#DAD7E0] bg-[#FAFAFB] inline-flex items-center justify-center rounded-2xl cursor-pointer hover:bg-gray-200">
