...
import { Briefcase, Call, Hierarchy, Sms } from "iconsax-react";
          ...
          <div className="flex flex-col gap-5 mt-2 px-5">
            ...
            <div className="flex flex-col w-full gap-5">
              ...
              <div className="flex items-center justify-between gap-1 w-full">
                ...
                {/* value */}
                <h4 className="font-semibold text-sm text-black">Asemota Joel</h4>
              </div>
              ...
              <div className="flex items-center justify-between gap-1 w-full">
               ...
               <div className="flex items-center justify-between gap-1 w-full">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Hierarchy variant="Bulk" size={16} color="#48A9A6"/>
